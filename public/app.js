...
// _____ Форматирование вывода даты ___________
const toDate = (date) => {
...
// https://materializecss.com/tabs.html (Initialization tabs in
// login.hbs)
// var instance = M.Tabs.init(el, options);
instance = M.Tabs.init(document.querySelectorAll('.tabs'));
